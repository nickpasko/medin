...
(function ($) {
    $.fn.lightbox = function (options) {
        ...
        */
        function initialize() {
            ...
            var outerImage = '<div id="outerImageContainer"><div id="imageContainer"><iframe id="lightboxIframe"></iframe><img id="lightboxImage" /><div id="hoverNav"><a href="javascript://" title="' + opts.strings.prevLinkTitle + '" id="prevLink"></a><a href="javascript://" id="nextLink" title="' + opts.strings.nextLinkTitle + '"></a></div><div id="loading"><a href="javascript://" id="loadingLink"><img src="' + opts.fileLoadingImage + '"></a></div></div><a style="display:none;" href="javascript://" id="bottomNavClose" title="' + opts.strings.closeTitle + '"><img src="' + opts.fileBottomNavCloseImage + '" /></a></div>';
            ...
            imageData += '</div></div></div>'; //move close link to outerContainer. MedIn fix.
        ...
        */
        ...
        function doChangeImage() {
            ...
            imgPreloader.onload = function () {
                ...
                if (opts.fitToScreen) {
                    ...
                    var ratio;
                    var initialPageWidth = arrayPageSize[2] - 2 * opts.borderSize - 80; //double padding of image. MedIn fix.
        ...
        function resizeImageContainer(imgWidth, imgHeight) {
            ...
            var widthNew = Math.max(350, imgWidth + (opts.borderSize * 2) + 80); //80 - double padding of image. dotorg fix.
            var heightNew = (imgHeight + (opts.borderSize * 2) + 80);
        ...
        function showImage() {
            $('#loading').hide();
            $('#bottomNavClose').show(); //dotorg fix
    ...
    $.fn.lightbox.defaults = {
        allSet: false,
        fileLoadingImage: '/content/i/skull-white.gif',
        fileBottomNavCloseImage: '/content/i/close.gif',
        overlayOpacity: 0.6,
        borderSize: 10,
